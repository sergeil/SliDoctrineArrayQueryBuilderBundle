...
require_once __DIR__ . '/../../../SortingFieldResolving/SortingFieldAnnotations.php';

use Sli\DoctrineArrayQueryBuilderBundle\SortingFieldResolving\AnnotationSortingFieldResolver;
